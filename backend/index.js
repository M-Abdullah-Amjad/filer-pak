...
const MONGO_URI = "mongodb+srv://ismailkhan194714:9sC0VWurP3YoIGQF@pakfiller1.wgl0knf.mongodb.net/pakfiller_db?retryWrites=true&w=majority&appName=Pakfiller1";
const JWT_SECRET = "complex_secret_key_here_replace_with_strong_value"; // IMPORTANT: Change this to a strong, unique value
const CORS_ORIGIN = ['http://localhost:3000', 'https://pak-filler-front.vercel.app'];
...
process.env.NODE_ENV = "production"; // It's better to set this to 'production' for Vercel
